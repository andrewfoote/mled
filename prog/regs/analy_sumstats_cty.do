 ...
 *gen sh_5=total_ext_shareLF>0.05
 gen noinsts=cty_insts_47==0 & cty_insts_69==0
 gen workage=total_age_19_44+total_age_45_59
 gen no_fouryear=cty_insts_47+cty_insts_6==cty_instc
 foreach g of varlist total_age* total_pop workage{
	replace `g'=`g'/1000
	}
 
 ffffffff
label var total_ext           "Mass Layoffs"
label var total_ext_share     "Mass Layoffs/Labor Force"
label var sh_1                "Layoffs $>$ 1\% of LF"
label var sh_5                "Layoffs $>$ 5\% of LF"
...
esttab using "${tabdir}/lev/table_sumstats.tex", main(mean %09.3g) aux(sd %09.2g) `theusual' prehead(" ") prefoot(" ") posthead(" ") postfoot(" ")
fff
